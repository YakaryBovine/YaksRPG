...
public sealed class Berserker : ICharacterClass
{
  ...
  public IEnumerable<Feature> Features { get; } = new[]
  {
    ...
    new Feature
    {
      Name = "Improved Critical", Description = "Your attacks score a critical hit on a roll of 18 or higher."
    },
    ...
    new Feature
    {
      Name = "Unrelenting",
      Description =
        "When you are reduced to 0 Hit Points, you can make a DC 10 Constitution Saving Throw to drop to 1 Hit Point instead. Each time you use this feature after the first, the DC increases by 5. The DC is reset to 10 when you Rest|rest."
    },


    new Feature
    {
      Name = "Unstoppable Force", Description = """
    ...
    new Feature { Name = "Fast Movement", Description = "Your speed increases by 10 feet." },
    ...
    new Feature
    {
      Name = "Pure Instinct", Description = "You can't be Surprised, and you have Advantage on Initiative checks."
    },
